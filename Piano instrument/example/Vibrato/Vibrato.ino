/*
   ...
   Quinto Proyecto Librería "TODO" 
    Sketch para controlar el Vibrato del piano.

    El Vibrato es un efecto de sonido que se asemeja
    a una vibración en las notas, para que este
    funcione, el sustain debe estar activado
    ...
    Los interruptores o pulsadores como también se les
